...
>>>>>>> 0fb7c284f38b62d91a9b67cbe399b43e25442511
...
In summary, from the presentation today, we conclude that for question1 when comparing the distribution of medal in different country aound the world, America appears to have the most medals in the world. In addtional, for question two, we have found that the sport athletics have the largest number of athletics, and in this sports, The United States accumulated the most gold MEDALS in each year. 
